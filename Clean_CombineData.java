...
public class Clean_CombineData {
    ...
    // Row is valid if at least one cell is non-empty
    ...
    // Updated method to remove null and "null" strings before writing
        ...
        try (BufferedWriter bw = new BufferedWriter(new FileWriter(outputPath))) {
            ...
            for (Map<String, String> row : rows) {
                ...
                for (String header : headers) {
                    ...
                    // Remove null or literal "null" strings
